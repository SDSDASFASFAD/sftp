error id: file:///E:/IDEA_PROJECT/sftp/src/main/java/beijing/SyncFiles.java:_empty_/SftpException#
file:///E:/IDEA_PROJECT/sftp/src/main/java/beijing/SyncFiles.java
empty definition using pc, found symbol in pc: _empty_/SftpException#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 1462
uri: file:///E:/IDEA_PROJECT/sftp/src/main/java/beijing/SyncFiles.java
text:
```scala
package beijing;
...
//        System.out.println("setting = " + setting);
    ...
    public static void main(String[] args) throws SftpExcept@@ion, InterruptedException {
